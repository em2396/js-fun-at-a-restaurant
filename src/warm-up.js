...
var vegetables = ['broccoli', 'carrots', 'edamame', 'celery', 'brussel sprouts'];
...
// different fruits.
var fruits = ['apple', 'pomegranate', 'strawberry', 'raspberry', 'banana', 'grapefruit', 'orange'];
...
//store hourss, location, sells alcohol, amount of employees
